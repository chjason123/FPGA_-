...
set_property -dict {PACKAGE_PIN G22 IOSTANDARD LVCMOS25} [get_ports {i_mode[1]}]
set_property -dict {PACKAGE_PIN H22 IOSTANDARD LVCMOS25} [get_ports {i_mode[0]}]
...
set_property -dict {PACKAGE_PIN F21 IOSTANDARD LVCMOS25} [get_ports {i_random_speed}]
